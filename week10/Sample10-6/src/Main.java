...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String[][] students = {{"홍길동","2501002"},{"이재명","2501004"},{"윤석열","2501005"},{"경복대","2501014"},{"오세훈","2501024"},{"강민성","2501032"},{"김진성","2501044"},{"니키타","2501055"},{"김정은","2501064"},{"김시온","2501074"}};
        ...
        while (i < students.length) {
            ...
            if ((score[i][0] >= 0 && score[i][0] <= 100) && (score[i][1] >= 0 && score[i][1] <= 100) && (score[i][2] >= 0 && score[i][2] <= 100)) {
                i++;
            } else {
        ...
        System.out.println("******************************************");
        for(i=0;i< students.length;i++) {
            System.out.printf("%7s %3s %3d %3d %3d %3d %5.1f %2d\n",students[i][1],students[i][0],score[i][0],score[i][1],score[i][2],score[i][3],avg[i],score[i][4]);
        }
        System.out.println("******************************************");
    }
}